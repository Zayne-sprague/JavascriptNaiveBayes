...
import {set_control} from "./reducers/reducers";
...
class TestComp extends Component {
    ...
    onPress(){
        ...
        const features = _.get(dispatch(build_feature_vectors("nb", bow_model, biases)), 'feature_vectors', {});

    }

    onTest(){
        const { docs, naivebayes, bow} = this.props;
...
export default connect(s => s)(TestComp)
